...
val hasKeystore = keystorePropertiesFile.exists() && run {
    keystoreProperties.load(FileInputStream(keystorePropertiesFile))
    val sf = keystoreProperties.getProperty("storeFile")
    sf != null && rootProject.file(sf).exists()
}

android {
    namespace = "com.wabees.wabees_android"
    ...
    defaultConfig {
        applicationId = "com.wabees.wabees_android"
    ...
    buildTypes {
        release {
            ...
            // Enable code and resource shrinking for smaller APK
